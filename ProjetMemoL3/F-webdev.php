...
$sql = 'SELECT * FROM work WHERE service = "Web development"';
...
<html lang="en">
  <head>
    ...
    <title id="headTitle">Web development</title>
    ...
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        ...
        <p>
            ...
            <a type="button"  href="./A-webdev.php" class="btn btn-primary my-2">View client's announcements</a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="container">
          ...
          <form action="F-webdev.php" method="POST" >
...
<?php foreach($users as $user): ?>
    ...
    <img src="./pics/webdesign.svg" width="100%" height="225">
            <div class="card-body">
