  ...
  <div class="container">
    ...
    <div class="col-sm-12 col-md-6 col-lg-4"> 
        <div class="card bg-dark text-light mb-3">
            <div> 
             <a href="./F-editing.php" > <img src="./pics/editiing.svg" width="354" height="257" alt=""  id="cardimg" class="card-img-top"> 
            </div>
        ...
        <div class="col-sm-12 col-md-6 col-lg-4"> 
          <div class="card bg-dark text-light mb-3">
              <div>
                <a href="./F-webdev.php" > <img  src="./pics/webdesign.svg" width="354" height="257"  alt="" id="cardimg" class="card-img-top">
              </div>
               <div class="card-body text-center">
        ...
        <div class="col-sm-12 col-md-6 col-lg-4"> 
          <div class="card bg-dark text-light mb-3">
              <div>
                <a href="./F-prog.php" > <img  src="./pics/programming.svg" width="354" height="257" alt="" id="cardimg" class="card-img-top">
              </div>
               <div class="card-body text-center">
        ...
        <div class="col-sm-12 col-md-6 col-lg-4"> 
          <div class="card bg-dark text-light mb-3">
              <div>
                <a href="./F-logo.php"> <img  src="./pics/logo.svg" width="354" height="257" alt="" id="cardimg" class="card-img-top">
              </div>
               <div class="card-body text-center">
        ...
        <div class="col-sm-12 col-md-6 col-lg-4"> 
          <div class="card bg-dark text-light mb-3">
              <div>
                <a href="./F-trans.php" > <img  src="./pics/trans.svg" width="354" height="257" alt="" id="cardimg" class="card-img-top">
              </div>
               <div class="card-body text-center">
        ...
        <div class="col-sm-12 col-md-6 col-lg-4"> 
          <div class="card bg-dark text-light mb-3">
              <div>
                <a href="./F-montage.php" >  <img  src="./pics/montage.svg" width="354" height="257" alt="" id="cardimg" class="card-img-top">
              </div>
               <div class="card-body text-center">
