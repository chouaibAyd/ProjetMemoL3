...
$sql = 'SELECT * FROM work WHERE service = "Translation"';
...
<html lang="en">
  <head>
    ...
    <title id="headTitle">Translation</title>
  ...
  <section class="py-4 text-center container" >
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light"  name="domaine">Translation</h1>
        <p class="lead text-muted"  name="serviceDetailles">Arabic , English , Franch , Espagnol , Russian , Turkish , Japanese , ...</p>
        <p>
            ...
            <a type="button"  href="./A-trans.php" class="btn btn-primary my-2">View client's announcements</a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="container">
          ...
          <form action="F-trans.php" method="POST" >
...
<?php foreach($users as $user): ?>
    ...
    <img src="./pics/trans.svg" width="100%" height="225">
            <div class="card-body">
