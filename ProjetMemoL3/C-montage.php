...
$sql = 'SELECT * FROM announcement WHERE service = "Montage"';
...
<html lang="en">
  <head>
    ...
    <title id="headTitle">Montage</title>
    ...
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        ...
        <p>
            ...
            <a type="button"  href="./W-montage.php" class="btn btn-primary my-2" >Find a freelancer</a>
