...
$sql = 'SELECT * FROM work WHERE service = "Editing"';
    ...
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        ...
        <p>
            ...
            <a type="button"  href="./A-editing.php" class="btn btn-primary my-2">View client's announcements</a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="container">
          ...
          <form action="F-editing.php" method="POST" enctype="multipart/form-data">
...
<?php foreach($users as $user): ?>
    ...
    <img src="./pics/editiing.svg" width="100%" height="225">
            <div class="card-body">
